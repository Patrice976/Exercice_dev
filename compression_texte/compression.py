...
print(type(wordToCode))
t = cut(testTxt) #On coupe le texte
print(t) #on vérifie que la fonction renvois bien ce qu'on attend 
st = rebuild(t) # On reconstruit le texte
print(st) #On vérifie que la fonction renvois bien ce qu'on attend 

print(compress(t,wordToCode))